...
<html lang="en">
	<head>
        ...
        <link rel="stylesheet" href="styledeco1800.css">
    ...
    <body>
        ...
        <div class="container">
            <h1 class="title">Choose Character</h1>
           
            <a href="catch_me_if_you_can_quiz2m.php"><button class="male">Male</button></a>
            <a href="catch_me_if_you_can_quiz2female.php"><button class="female">Female</button></a>
